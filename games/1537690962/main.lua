...
local homeTab_statsSection = homeTab:CreateSection("stats")

local homeTab_configSection = homeTab:CreateSection("config")

-- -- TODO: Add auto-loading of configs.
-- homeTab_configSection:CreateTextBox("name", 'ex: sleepyautofarm', false, function(value)
-- 	temporary.configurationName = value
-- end)
-- homeTab_statsSection:CreateLabel("⌛: 0") -- TODO: Create labels for the last elapsed time between hive conversions.
-- homeTab_statsSection:CreateLabel("🍯: 0")
