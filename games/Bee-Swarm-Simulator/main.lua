...
local 1_1_2 = hometab:CreateSection("ui")
...
local uitoggle = guisettings:CreateToggle("UI Toggle", nil, function(State) Window:Toggle(State) end) uitoggle:CreateKeybind(tostring(Config.Keybind):gsub("RightShift", ""), function(Key) Config.Keybind = Enum.KeyCode[Key] end) uitoggle:SetState(true) -- ?
