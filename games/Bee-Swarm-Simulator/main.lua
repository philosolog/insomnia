...
local autofarmtoggle = farmo:CreateToggle("autofarm ⚙", nil, function(State) sleepy.toggles.autofarm = State end) autofarmtoggle:CreateKeybind("U", function(Key) end) -- TODO: Add KeyCode.Tab compatibility; add listener for keybind inputs.
...
farmo:CreateToggle("fuzzy bombs", nil, function(State) sleepy.toggles.farmfuzzy = State end)
...
--farmt:CreateToggle("⚠️ snowflakes", nil, function(State) sleepy.toggles.farmsnowflakes = State end)
farmt:CreateToggle("⚠️ tp to rare tokens", nil, function(State) sleepy.toggles.farmrares = State end)
...
extras:CreateButton("hide nickname", function() loadstring(game:HttpGet("https://raw.githubusercontent.com/philosolog/sleepy-pbe/main/utilities/hidenickname.lua"))()end)
